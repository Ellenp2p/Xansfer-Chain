...
fn default_chains_mainnet() -> Vec<ChainConfig> {
    vec![
        ...
        ChainConfig { domain: 8, name: "Sui".into(), chain_id: None, rpc_url: "https://fullnode.mainnet.sui.io:443".into(), explorer_url: "https://suiscan.xyz/mainnet/home".into(), usdc_address: "0xdba34672e30cb065b1f93e3ab55318768fd6fef66c15942c9f7cb845e24ff689::usdc::USDC".into(), usdc_sac: None, cctp_versions: vec![2], chain_type: ChainType::Sui, supports_fast_transfer: false, supports_forwarding: false, block_time_ms: 2000, finality_blocks: 1 },
        ...
        ChainConfig { domain: 25, name: "Starknet".into(), chain_id: None, rpc_url: "https://starknet-mainnet.public.blastapi.io".into(), explorer_url: "https://starkscan.co".into(), usdc_address: "".into(), usdc_sac: None, cctp_versions: vec![2], chain_type: ChainType::Starknet, supports_fast_transfer: true, supports_forwarding: false, block_time_ms: 2000, finality_blocks: 1 },
        evm(26, "Arc", 252, "https://rpc.arc.org", "https://explorer.arc.org", "0x0000000000000000000000000000000000000000", false, true, 1000, 1),
        ChainConfig { domain: 27, name: "Stellar".into(), chain_id: None, rpc_url: "https://soroban-rpc.stellar.org".into(), explorer_url: "https://stellar.expert/explorer/public".into(), usdc_address: "USDC:GA5ZSEJYB37JRC5AVCIA5MOP4RHTM335X2KGX3THOJQHJMR5KTSLSQ".into(), usdc_sac: Some("CBIELTK6YBZJU5UP2WWQEUCYKLPU6AUNZ2BQ4WWFEIE3USCIHMXQDAMA".into()), cctp_versions: vec![2], chain_type: ChainType::Stellar, supports_fast_transfer: false, supports_forwarding: false, block_time_ms: 5000, finality_blocks: 1 },
...
fn default_chains_testnet() -> Vec<ChainConfig> {
    vec![
        ...
        ChainConfig { domain: 25, name: "Starknet Sepolia".into(), chain_id: None, rpc_url: "https://starknet-sepolia.public.blastapi.io".into(), explorer_url: "https://sepolia.starkscan.co".into(), usdc_address: "0x0512feAc6339Ff7889822cb5aA2a86C848e9D392bB0E3E237C008674feeD8343".into(), usdc_sac: None, cctp_versions: vec![2], chain_type: ChainType::Starknet, supports_fast_transfer: true, supports_forwarding: false, block_time_ms: 2000, finality_blocks: 1 },
        ...
        ChainConfig { domain: 8, name: "SUI Devnet".into(), chain_id: None, rpc_url: "https://fullnode.devnet.sui.io:443".into(), explorer_url: "https://suiscan.xyz/testnet/home".into(), usdc_address: "0x3a915322be45c414508712322acdf4f4d5c94ac2c262f635f037e2a26f364dd3::usdc::USDC".into(), usdc_sac: None, cctp_versions: vec![2], chain_type: ChainType::Sui, supports_fast_transfer: true, supports_forwarding: false, block_time_ms: 500, finality_blocks: 1 },
        ChainConfig { domain: 14, name: "Aptos Testnet".into(), chain_id: None, rpc_url: "https://fullnode.testnet.aptoslabs.com/v1".into(), explorer_url: "https://explorer.aptoslabs.com/?network=testnet".into(), usdc_address: "0xf22bede237a07e121b56d91a491eb7bcdfd1f5907926a9e58338f964a01b17fa::asset::USDC".into(), usdc_sac: None, cctp_versions: vec![2], chain_type: ChainType::Aptos, supports_fast_transfer: true, supports_forwarding: false, block_time_ms: 1000, finality_blocks: 1 },
    ]
}
...
fn evm(
    ...
    let (v1_tm, _v1_mt) = v1_contracts_mainnet(domain);
